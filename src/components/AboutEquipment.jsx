...
export default function AboutEquipment() {
  return (
    <section
      id="about"
      className="bg-neutral-950 text-white py-24 px-6 md:px-12 lg:px-24 overflow-hidden border-b border-neutral-900">
      <div className="max-w-7xl mx-auto space-y-24">
        {/* about section */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          {/* photographer image */}
          <motion.div
            ...
            <div className="relative rounded-3xl overflow-hidden border border-neutral-800 bg-neutral-900 aspect-[4/5]">
              <img
                src="/camera-image.jpg"
          ...
          <motion.div
            ...
            {/* 3. key badges */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
              <div className="p-4 rounded-2xl bg-neutral-900/60 border border-neutral-800 space-y-2 hover:border-neutral-700 transition-colors">
                <FiShield className="w-6 h-6 text-emerald-400" />
                <h4 className="font-semibold text-sm">Infant Safe & Gentle</h4>
                <p className="text-xs text-neutral-400">
                  Calm, soothing environments tailored for delicate baby shoots.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mt-8">
            ...
            <motion.div
              ...
              <div className="relative rounded-3xl overflow-hidden border border-neutral-800 bg-neutral-900 aspect-square">
                ...
                {/* Floating Badge */}
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-neutral-950/85 backdrop-blur-md border border-neutral-800 flex items-center gap-3">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4 order-1 lg:order-2">
              <motion.div
                ...
                className="p-6 rounded-3xl bg-neutral-900/40 border border-neutral-800 hover:border-neutral-700 transition-all space-y-3">
              ...
              <motion.div
                ...
                className="p-6 rounded-3xl bg-neutral-900/40 border border-neutral-800 hover:border-neutral-700 transition-all space-y-3">
                <div className="w-10 h-10 rounded-xl bg-neutral-950 border border-neutral-800 flex items-center justify-center text-rose-400">
                  <FiStar className="w-5 h-5" />
                </div>
                <h3 className="font-semibold text-lg">Cinematic Depth</h3>
                <p className="text-xs text-neutral-400 leading-relaxed">
              ...
              <motion.div
                ...
                className="p-6 rounded-3xl bg-neutral-900/40 border border-neutral-800 hover:border-neutral-700 transition-all space-y-3">
                <div className="w-10 h-10 rounded-xl bg-neutral-950 border border-neutral-800 flex items-center justify-center text-emerald-400">
                  <FiHardDrive className="w-5 h-5" />
                </div>
                <h3 className="font-semibold text-lg">Redundant Data Safety</h3>
                <p className="text-xs text-neutral-400 leading-relaxed">
