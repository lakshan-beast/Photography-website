...
export default function ImageSlider() {
  ...
  return (
    <section
      ...
      className="text-white bg-neutral-950 py-16 px-4 md:px-12 border-t border-b border-neutral-900 overflow-hidden">
      <div className="max-w-7xl mx-auto space-y-8">
        {/* slider section header with scroll-triggered fade-in */}
        <motion.div
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={() => scroll("left")}
              className="p-3 rounded-full bg-neutral-900 border border-neutral-800 hover:bg-neutral-800 hover:border-neutral-700 transition-all text-neutral-300 hover:text-white cursor-pointer"
              aria-label="Previous Slide">
              <FiChevronLeft className="w-5 h-5" />
            </button>
            <button
