...
export default function FAQ() {
  ...
  return (
    <section className="bg-neutral-950 text-white py-20 px-6 md:px-12 lg:px-24 border-y border-neutral-900 overflow-hidden">
      <div className="max-w-4xl mx-auto space-y-12">
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-2xl bg-neutral-900/40 border border-neutral-800 overflow-hidden transition-colors hover:border-neutral-700"
                key={index}>
                <button
                  type="button"
                  onClick={() => toggleFAQ(index)}
                  className="w-full p-6 text-left flex justify-between items-center gap-4 hover:bg-neutral-900/80 transition-colors cursor-pointer">
                  <span className="font-semibold text-base md:text-lg text-neutral-200">
                    {faq.question}
                  </span>
